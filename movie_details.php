                ...
                <section class="days">
                    <table>
                        ...
                        ?>
                                ...
                                <a href="seat.php?date=<?php echo $date ?>&id=<?php echo $current_movie_id ?><?php echo !empty($user_id) ? '&userid=' . $user_id : ''; ?>" class="<?php if ($num_shows == 0) echo 'disabled-link' ?>"><?php echo $date ?></a><br>
